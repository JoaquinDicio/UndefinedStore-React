    ...
    return(
        <div className="row justify-content-center container itemCount">
            ...
            <div className="row item-count-info align-items-center">
                ...
                <Button clicked={x<currentStock?onSum:()=>alert('No hay mas unidades de este producto')} text={'+'} btnStyle={'btn btn-success col-2 text-center'}/>
            </div>
            <Button clicked={()=>onAdd(x)} text={'Agregar al carrito'} btnStyle={'btn btn-primary'}/>
        </div>
    )
}